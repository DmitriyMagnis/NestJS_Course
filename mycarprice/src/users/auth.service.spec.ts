...
describe('AuthService', () => {
  ...
  it('returns a user if an valid password is provided', async () => {
    await service.signUp('asdflkj@asdlfkj.com', 'passowrd');
    const user = await service.signIn('asdflkj@asdlfkj.com', 'passowrd');
